...
- closeModal - закрывает и очищает модальное окно.
...
- showCard - показывает каталог товаров на главной странице.
...
- updatePaymentInfo - записать данные введенные в форме в модель, валидирует эти эти данные и отображает результат.
- updateAdressInfo - записать данные введенные в форме в модель, валидирует эти эти данные и отображает результат.
- updatePhoneInfo - записать данные введенные в форме в модель, валидирует эти эти данные и отображает результат.
...
- openSuccess - показывает экран успешного заказа, очищает содержимое модели клиента и корзины.
